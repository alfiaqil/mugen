...
triggerall = ctrl
triggerall = !inguarddist
trigger1 = enemynear,stateno = [823,824]
...
value = 14251
triggerall = var(59) = 1
triggerall = vel y > -1 && vel y < 15
triggerall = pos y > 0
triggerall = alive
trigger1 = stateno = [5030,5172]

[State -1, Super Speed Dash]
type = ChangeState
value = 14251
triggerall = !Var(58)
triggerall = command = "KKK"
...
trigger1 = AnimElemTime(AnimElemNo(0) + 3) < 0
