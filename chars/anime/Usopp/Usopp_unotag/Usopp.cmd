...
triggerall = Partner, Time >= 250 && Time > 0
...
triggerall = AIlevel > 4 || ((random < 250) && Time <= 1)
triggerall = statetype != A
triggerall = (var(58) != [200,499]) || (Random < 10)
trigger1 = ctrl
trigger1 = p2bodydist X > 100
...
trigger12 = stateno = 1120 && movecontact
trigger13 = stateno = 1200 && movecontact
trigger14 = stateno =1210 && movecontact
trigger15 = stateno = 1220 && movecontact
...
trigger8 = stateno = 1030 && movecontact
trigger9 = stateno = 1040 && movecontact
...
triggerall = (Var(0) = 0)
triggerall = NumHelper(3201) > 0
triggerall = Helper(3201), StateNo = 3201
triggerall = AILevel >0 && roundstate = 2 && statetype !=A
triggerall = (p2stateno!=[120,155]) && (p2statetype!=L)
triggerall = stateno != [800,8003]
triggerall = p2statetype !=A||((p2bodydist y =[-55,-20])&&enemy,vel y >=0&& AILevel >3)
...
trigger2 = (stateno = [200,499]) || (stateno = [1000,1029])|| (stateno = [1100,1109])
...
trigger2 = (stateno = [600,699]) || (stateno = [1030,1099])|| (stateno = [1110,1199])|| (stateno = [1200,1999])
