...
trigger3 = stateno = 1350 ;Air blocking
;---------------------------------------------------------------------------
; REPLICATED JUMP ATTACK STATES
; USING THE TRIGGER OF VARIABLE 20 BEING ON (10)
; WHICH HAPPENS WHEN WE ENTER FLY MODE.
...
triggerall = command = "y"
triggerall = movetype != H
triggerall = stateno != 1920
trigger1 = statetype = A
trigger2 = stateno = 1910 && movecontact
...
trigger1 = statetype = A
trigger2 = stateno = 1930 && movecontact
...
triggerall = (2*AILevel) * AILevel * 2 > random
triggerall = ctrl
