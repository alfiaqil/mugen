...
trigger2 = movecontact && stateno = 3000; && animelem <= 30
...
;Max cancel
trigger3 = var(56) >= 1 && stateno != [1300,1335]
...
triggerall = power >= 1000
trigger1 = ctrl
trigger2 = movecontact && stateno = [200,250] 
...
trigger2 = stateno = 100 && time > 5
trigger3 = stateno = 52
trigger4 = movecontact && stateno = [200,245] 
trigger5 = movecontact && stateno = [400,460] 
