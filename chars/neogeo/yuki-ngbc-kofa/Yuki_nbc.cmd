;-| ���K�E�Z |--------------------------------------------------------
[Command]
name = "���̕ϐg!�`�F���W�E�A�g�~�b�N�K�C�E�l�I�X"
command = ~D,F,D,F, z
time = 30
...
type = ChangeState
value = 2400
triggerall = command = "���̕ϐg!�`�F���W�E�A�g�~�b�N�K�C�E�l�I�X"
...
type = ChangeState
value = 2300
triggerall = command = "���h���X�e�[�^�X�A�b�v"
...
type = ChangeState
value = 2200
triggerall = command = "���h��MAX330���K�r�[��"
...
value = 1600
triggerall = !AILevel
triggerall = command = "�t�@�C���[�X�[�v���b�N�X�z�[���h"
triggerall = statetype != A
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
;---------------------------------------------------------------------------
...
type = ChangeState
value = 1250
triggerall = command = "SE�EN�EGO�EKU�`��"
triggerall = var(21) >= 1
triggerall = statetype != A
trigger1 = ctrl
trigger2=(stateno=[200,499]) && movecontact
